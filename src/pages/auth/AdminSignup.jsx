...
const AdminSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Admin account request submitted! It will be reviewed by the original admin.')
      setTimeout(() => {
        ...
        <Card sx={{ 
          ...
          <CardContent sx={{ p: 4 }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                {!emailVerified || !phoneVerified ? 'Verify Email & Phone to Continue' : (loading ? 'Creating Account...' : 'Create Admin Account')}
              </Button>
            </form>
            ...
            <Box sx={{ mt: 3, p: 2, bgcolor: '#f5f5f5', borderRadius: 1 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                <Security sx={{ fontSize: 16, color: '#000000' }} />
